...
### Full Stack Developer (MERN) · Frontend Lead · Trainer

**React & Node.js Expert with 4+ years building scalable, production-grade web applications**
...
- React Hooks, Context API, functional components, React Router
...
- JWT-based authentication, OAuth integration, role-based access control
...
|---|---|---|---|
| **Master of Information Technology** | University of Hyderabad | Aug 2019 – Jun 2021 | Hyderabad, India |
| **Bachelor of Information Technology** | GGSIP University | Aug 2015 – Jun 2019 | Delhi, India |
...
*Thanks for stopping by! Always open to connecting on interesting MERN stack & full-stack opportunities.* ✨
